class LoginView {
    ...
    <main class="container">
      ...
      <form id="form-sign-in">
        <div class="mb-2">
          <input type="email" id="emaillogin" class="form-control" placeholder="Seu melhor email">
        </div>
        <div class="mb-2">
          <input type="password" id="passwordlogin" class="form-control" placeholder="A mais secreta senha">
        </div>
